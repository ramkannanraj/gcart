          ...
          <div id="product">
            ...
            <div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
              ...
              <div id="input-option<?php echo $option['product_option_id']; ?>" class="input-option">
                <?php foreach ($option['product_option_value'] as $option_value) { ?>
                <div class="radio">                  
                    <input type="radio" name="option[<?php echo $option['product_option_id']; ?>]" id="option[<?php echo $option['product_option_id'].$i; ?>]" ng-model="<?php echo strtolower(str_replace(' ', '', $option['name'])); ?>" value="<?php echo $option_value['product_option_value_id']; ?>" <?php echo ($option_value['default'] == 1)? "checked=checked" : ''; ?> />
