<div id="cart" class="btn-group btn-block">
  <a data-toggle="dropdown" data-loading-text="<?php echo $text_loading; ?>" class="cart-items"><span><img src="catalog/view/theme/gemcart/stylesheet/images/shopping-card.png"></span><span id="cart-total"><?php echo $text_items; ?></span></a>
